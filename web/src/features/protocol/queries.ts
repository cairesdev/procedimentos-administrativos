...
import type { ProtocolSubject, Requirement, ServiceDetail, ServiceRecord } from "./types";
...
export const findServiceRecord = (id: string) =>
  apiRequest<ServiceDetail>(`/protocolo/atendimentos/${id}`);
