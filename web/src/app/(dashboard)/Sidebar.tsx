...
import { Building2, ChevronRight, FileSignature, Inbox, ShieldCheck } from "lucide-react";
import type { NavIcon, NavSection } from "@/shared/auth/navigation";
...
export const Sidebar = ({ sections }: { sections: NavSection[] }) => {
